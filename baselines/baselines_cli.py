...
def main(args):
    ...
    if args.epochs > 0:
        ...
        train_dataset = dataset_class(root_dir=data_raw_path, file_filter=f"**/*{args.train_city}*8ch.h5", **dataset_config, limit=args.limit, radius=args.radius,)
        val_dataset = dataset_class(
            root_dir=data_raw_path, file_filter=f"**/*{args.train_city}*8ch.h5", **dataset_config, limit=args.val_limit, radius=args.radius, augment=False,
        )
        # if geometric:
